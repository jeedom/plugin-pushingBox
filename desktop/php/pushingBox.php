...
$eqLogics = eqLogic::byType('pushingBox');
?>
...
<div class="row row-overflow">
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
        ...
        <?php
        if (count($eqLogics) == 0) {
            echo "<br/><br/><br/><center><span style='color:#767676;font-size:1.2em;font-weight: bold;'>{{Vous n'avez pas encore d'équipement PushingBox, cliquez sur Ajouter un équipement pour commencer}}</span></center>";
        } else {
            ?>
            <div class="eqLogicThumbnailContainer">
                ...
                foreach ($eqLogics as $eqLogic) {
                    ...
                    echo "<center>";
                    echo '<img src="plugins/pushingbox/doc/images/pushingbox_icon.png" height="105" width="95" />';
                    echo "</center>";
